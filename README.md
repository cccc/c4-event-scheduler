...
Events that have started but not ended yet (or, without an end time, whose day is not over) stay listed. Each event's `calendarUrl` is a deep link that opens the occurrence in the calendar.
