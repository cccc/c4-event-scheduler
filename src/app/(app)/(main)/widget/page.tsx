...
export default function WidgetPage() {
    const { data: spaces } = api.spaces.list.useQuery({
                        ...
                        <table className="w-full text-sm">
                            ...
                            <tbody className="divide-y">
                                ...
                                <tr>
                                    ...
                                    <td className="py-2">
                                        How far into the future to look (1–24
                                        months)
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="py-2">
                                        Output format: <code>json</code> or{" "}
                                        <code>html</code>
                                    </td>
                                </tr>
                                <tr>
