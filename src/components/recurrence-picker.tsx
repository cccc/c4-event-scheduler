...
export function parseRRuleToConfig(rruleString: string): RecurrenceConfig {
    ...
    if (options.byweekday && frequency === "weekly") {
        ...
        const byweekdayArr = Array.isArray(options.byweekday)
            ? options.byweekday
            : [options.byweekday];
        weekDays = byweekdayArr.map(
            (wd) => weekDayMap[getWeekdayNum(wd)] ?? "MO",
        );
    }
    ...
    return (
        <div className="space-y-4">
            ...
            <div>
                ...
                <Select
                    onValueChange={(v) =>
                        updateConfig("frequency", v as Frequency)
                    }
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center gap-2">
                            <input
                                ...
                                name="monthlyType"
                                onChange={() =>
                                    updateConfig("monthlyType", "dayOfMonth")
                                }
                                type="radio"
                            />
                            <span>Day</span>
                        ...
                        <label className="flex items-center gap-2">
                            <input
                                ...
                                name="monthlyType"
                                onChange={() =>
                                    updateConfig("monthlyType", "dayOfWeek")
                                }
                                type="radio"
                            />
                            <span>The</span>
                            ...
                            <Select
                                disabled={config.monthlyType !== "dayOfWeek"}
                                onValueChange={(v) =>
                                    updateConfig("dayOfWeek", v as WeekDay)
                                }
