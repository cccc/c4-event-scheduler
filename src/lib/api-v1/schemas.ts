...
const eventBaseShape = {
	...
	updatedByApiKeyId: z.string().uuid().nullable(),
	...
	createdBy: AuthorNameSchema,
	updatedBy: AuthorNameSchema,
	createdByApiKey: AuthorNameSchema,
	updatedByApiKey: AuthorNameSchema,
};
...
export const CreateEventSchema = z
	.object({
		spaceId: z.string().uuid(),
		eventTypeId: z.string().uuid(),
		summary: z.string().min(1).max(255).openapi({ example: "Team Meeting" }),
		...
		rrule: z.string().optional().openapi({ example: "FREQ=WEEKLY;BYDAY=WE" }),
